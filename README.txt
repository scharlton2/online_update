...
4. Commit changes made by the script to server (copy filed from dev to prod)

The process 4. takes some time, because you need to build repository for prod with
